...
def event_to_image(_x, _y, pol, t, H, W):
...
def visualize_event(event_data_list, height, width):
    event_vis_list = []
    for event_data in event_data_list:
        ...
        t = event_data[..., 2]
        p = event_data[..., 3]
        event_vis = event_to_image(x, y, p, t, height, width)
        event_vis_list.append(event_vis)

    return event_vis_list
